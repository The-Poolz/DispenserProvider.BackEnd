...
public class AdminRequestValidatorTests
{
    public class ValidateAndThrow
    {
        ...
        internal void WhenCollectionNotSorted_ShouldThrowException()
        {
            ...
            testCode.Should().Throw<ValidationException>()
                .WithMessage($"Validation failed: {Environment.NewLine} -- UsersToValidateOrder: Addresses must be in ascending order. Found '0x0000000000000000000000000000000000000002' >= '0x0000000000000000000000000000000000000001' Severity: Error");
        }
